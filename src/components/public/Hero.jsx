...
export function Hero() {
  const { eyebrow, title, copy, buttonText1, buttonText2 } = siteContent.hero;

  return (
    <section id="home" className="relative min-h-[92svh] overflow-hidden bg-primary text-primary-foreground">
      <img src="/assets/luxury-spa.jpg" alt="A serene Mara Retreat massage room" width={1600} height={1200} className="absolute inset-0 size-full object-cover object-center" />
      ...
      <div className="relative mx-auto flex min-h-[92svh] max-w-[1480px] items-end px-5 pb-20 pt-40 md:px-10 lg:items-center lg:pb-0">
        ...
        <Link to="/about" aria-label="Discover Mara" className="absolute bottom-8 right-10 hidden items-center gap-3 text-xs uppercase tracking-[0.15em] lg:flex">
